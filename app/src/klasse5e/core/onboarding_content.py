...
WEBUNTIS_GUIDANCE = {
    ...
    "webuntis_absences": ("Abwesenheiten", "Importierte Abwesenheiten persönlich anzeigen. Meldungen bleiben lokale Entwürfe; eine Übertragung erfolgt erst später gemeinsam im Browser."),
}
