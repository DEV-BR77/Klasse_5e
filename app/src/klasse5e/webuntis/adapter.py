...
CAPABILITIES = (
    ...
    Capability(
        "timetable_weekly",
        "timetable_weekly",
        "Angereicherter Wochenstundenplan lesen",
        "personal",
        True,
    ),
    Capability(
        "substitutions", "getSubstitutions", "Vertretungen und Aenderungen lesen", "class", False
    ),
...
class WebUntisAdapter:
    def __init__(
        self, *, server, school, username, password, useragent="Klasse-5e-WebUntis-Pilot/9A"
    ):
