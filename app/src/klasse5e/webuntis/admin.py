...
class SyncScheduleAdmin(admin.ModelAdmin):
    ...
    fields = ("enabled", "timezone_name", "times", "weekdays_only", "weekends", "holidays", "max_runs_per_day", "min_interval_minutes")
...
class WebUntisConnectionAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("username_encrypted", "password_encrypted", "last_checked_at", "last_successful_sync_at")


@admin.register(SyncRun)
class SyncRunAdmin(admin.ModelAdmin):
    list_display = ("connection", "trigger", "status", "started_at", "finished_at", "change_count", "error_code")
